    ...
    <div className="flex min-h-screen w-full items-center justify-center bg-[var(--bg)] px-4">
      <div className="w-full max-w-sm">
        <div className="mb-6 text-center">
          ...
          <h1 className="font-display text-2xl font-extrabold text-[var(--ink)]">Business sign in</h1>
        ...
        <p className="mt-5 text-center text-[13px] text-[var(--muted)]">
          ...
          <Link to="/" className="font-bold text-[var(--brand)] hover:underline">Get in touch</Link>
        </p>
      </div>
    </div>
  );
