...
export default function AdminLogin() {
  ...
  useEffect(() => {
    document.title = "Barista Login | Coffesarowar Cafe";
  }, []);
  ...
  return (
    <div className="flex min-h-screen w-full items-center justify-center bg-[#121212] font-sans text-[#EBE6DF] px-4">
      <div className="relative w-full max-w-md">
        ...
        <div className="flex flex-col items-center text-center mb-8">
          ...
          <h1 className="mt-4 text-3xl font-serif font-normal text-[#EBE6DF] tracking-tight">
            Coffesarowar<span className="italic"> Staff</span>
          </h1>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <div className="space-y-1.5">
              ...
              <div className="flex items-center gap-3 border border-[#2D2D2D] bg-[#121212] px-4 py-3.5 transition-colors focus-within:border-[#EBE6DF] rounded-[32px] overflow-hidden">
                ...
                <input
                  type="email"
                  placeholder="barista@coffesarowar.cafe"
                  {...register("email")}
        ...
        <p className="mt-8 text-center text-xs text-[#A3A3A3]">
          Coffesarowar Cafe Staff Directory. Unauthorized entry attempts are logged.
        </p>
      </div>
    </div>
  );
