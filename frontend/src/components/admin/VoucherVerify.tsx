...
export function VoucherVerify() {
  ...
  return (
    <section
      ...
      className="border border-[#2D2D2D] bg-[#1A1A1A] p-4 xs:p-5 sm:p-6 lg:p-8 rounded-[24px] sm:rounded-[48px] overflow-hidden shadow-none text-[#EBE6DF]"
    >
      <div className="mb-6 flex items-center gap-3">
        <div className="flex size-8 xs:size-10 items-center justify-center border border-[#2D2D2D] bg-[#121212] rounded-[10px] xs:rounded-[16px] shrink-0">
        ...
        <div>
          ...
          <p className="mt-0.5 text-[11px] xs:text-xs sm:text-sm leading-relaxed text-[#A3A3A3]">
